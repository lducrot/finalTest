...
namespace FinalTest.Tests
{
    ...
    public class LinqTests
    {
        ...
        public void RécupérerUneChaîneContenantLesNombresImpairsAuFormatTextuel()
        {
            ...
            // retourne une string en utilisant Linq 
            // (i.e sans utiliser de boucles) -> Aggregate + OrderBy
            var texteNombresImpairs = nombres.TexteNombresImpairs; 
        ...
        public void RécupérerLePremierNombreDontLeTexteContientPlusDe5Caractères()
        {
            ...
            // retourne une string en utilisant Linq (i.e sans utiliser de boucles) -> First
            var premierNombreDontLeTexteContientPlusDe5Caractères = nombres.PremierNombreDontLeTexteContientPlusDe5Caractères; 
        ...
        public void RécupérerLes4NombresSupérieursA3()
        {
            ...
            // retourne un IEnumerable<int> en utilisant Linq 
            //(i.e sans utiliser de boucles) -> OrderBy + Skip + Take
            var quatreNombresSupérieursSuivant3 = nombres.QuatreNombresSupérieursSuivant3; 
